...
define config.name = _("Forensics L1 prototype")
...
define config.mouse['computer_lifted'] = [('/images/mouse/computer_lifted.png', 0, 0)]
define config.mouse['powder']= [('/images/mouse/magnetic_powder_resized.png', 0, 0)]
...
define config.mouse['gel_lift'] = [('/images/mouse/gel_lift_resized.png', 0, 0)]
define config.mouse['gel_lifted'] = [('/images/mouse/lifted.png', 0, 0)]
...
define build.name = "ForensicsL1prototype"
...
define config.save_directory = "ForensicsL1prototype-1707920630"
