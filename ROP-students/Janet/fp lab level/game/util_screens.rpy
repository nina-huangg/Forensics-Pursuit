...
screen case_files_screen():
    ...
    showif show_case_files:
        ...
        hbox:
            xpos 0.40 ypos 0.20
            imagebutton:
                idle "evidence_crowbar" 

                action [ToggleVariable('show_case_files'),SetVariable('current_evidence', crowbar),Function(set_cursor, 'crowbar')]
 
        hbox:
            xalign 0.44 ypos 0.41
            text("{color=#ffffff}Crowbar{/color}")
    ...
    showif show_toolbox:
            hbox:
                ...
                imagebutton:
                    ...
                    action [Function(set_cursor, 'superglue'), SetVariable('current_tool', 'superglue')]
            hbox:
                xpos 0.90 ypos 0.32
                imagebutton:
                    ...
                    action [Function(set_cursor, 'water'), SetVariable('current_tool', 'water')]
            # hbox:
            #     xpos 0.91 ypos 0.53
            #     imagebutton:
            ...
            #         action [Function(set_cursor, 'lifting_tape'), SetVariable('current_tool', 'lifting_tape')]
            ...
            hbox:
                ...
                imagebutton:
                    ...
                    action [Function(set_cursor, 'camera'), SetVariable('current_tool', 'camera')]
