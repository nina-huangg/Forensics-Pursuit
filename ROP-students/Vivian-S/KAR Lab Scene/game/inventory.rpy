                                    ...
                                    for item3 in environment_sprites:
                                        ...
                                        if items_overlap == True:
                                            ...
                                            if item1.type == "lid" and item3.type == "evidence_tray":
                                                ...
                                                break
                                            if item1.type == "duct_tape" and item3.type == "blue_tray":
                                                ie_combine = True
                                                removeInventoryItem(item1)
                                                removeEnvironmentItem(item3)
                                                # item3.idle_image = Image("Environment Items/lid_on_tray-idle.png")
                                ...
                                for item3 in environment_sprites:
                                    ...
                                    if items_overlap == True:
                                        ...
                                        if item1.type == "gloves_box" and item3.type == "hands":
                                            ...
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "gloves_box" and item3.type == "hands1":
                                            ie_combine = True
                                            # removeToolboxItem(item1)
                                            removeEnvironmentItem(item3)
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            item1.zorder = 0
                                            renpy.show_screen("gloved1")
                                            toolboxpop_SM.redraw(0)
                                            environment_SM.redraw(0)
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "tapeglo" and item3.type == "tape_in_tray":
                                            ie_combine = True
                                            removeToolboxItem(item1)
                                            removeEnvironmentItem(item3)
                                            renpy.jump("pour_tapeglo")
                                            toolboxpop_SM.redraw(0)
                                            environment_SM.redraw(0)
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "tweezers" and item3.type == "tape_in_tray":
                                            ie_combine = True
                                            # removeToolboxItem(item1)
                                            removeEnvironmentItem(item3)
                                            addToInventory(["tape_in_tweezers"])
                                            renpy.show_screen("inspectItem", ["tape_in_tweezers"])
                                            renpy.jump("distilled_water")
                                            toolboxpop_SM.redraw(0)
                                            environment_SM.redraw(0)
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "camphor_smoke" and item3.type == "silver_tray":
                                            ie_combine = True
                                            removeToolboxItem(item1)
                                            characterSay(who = "", what = ["Nice! Now let's light it on fire!"])
                                            toolboxpop_SM.redraw(0)
                                            environment_SM.redraw(0)
                                            renpy.restart_interaction()
                                            renpy.jump("setupCamphor3")  
                                            break
                                        elif (item1.type == "lighter" and item3.type == "camphor_cube") or (item1.type == "lighter" and item3.type == "silver_tray"):
                                            ie_combine = True
                                            removeToolboxItem(item1) 
                                            renpy.jump("lit_cube")
                                            toolbox_SM.redraw(0)
                                            ...
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "tweezers" and item3.type == "lid_on_tray":
                                            ie_combine = True
                                            addToToolbox(["lid_in_tweezers"])
                                            renpy.show_screen("inspectItem", ["lid_in_tweezers"])
                                            renpy.show
                                            # removeToolboxItem(item1)
                                            characterSay(who = "", what = ["Now, let's hold the lid over the fire."])
                                            toolbox_SM.redraw(0)
                                            environment_SM.redraw(0)
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "camel_brush" and item3.type == "piece1":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            ...
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "camel_brush" and item3.type == "piece2":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            ...
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "camel_brush" and item3.type == "piece3":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            ...
                                            renpy.restart_interaction()
                                            break
                                        elif item1.type == "camel_brush" and item3.type == "piece4":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
...
screen full_inventory:
    ...
    imagebutton:
        ...
        xpos 0.037 ypos 0.02 at half_size
