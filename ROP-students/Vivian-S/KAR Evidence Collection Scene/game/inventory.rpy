                            ...
                            if i_combine == False:
                                for item3 in environment_sprites:
                                    ...
                                    if items_overlap == True:
                                        ...
                                        if item1.type == "evidence_marker" and item3.type == "marker1":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            renpy.show_screen("marker1")
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            item1.zorder = 0
                                            toolbox_SM.redraw(0)
                                            ...
                                            break
                                        elif item1.type == "evidence_marker" and item3.type == "marker2":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            renpy.show_screen("marker2")
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            item1.zorder = 0
                                            toolbox_SM.redraw(0)
                                            ...
                                            #     renpy.jump("inside_study1_screen")
                                            break
                                        elif item1.type == "evidence_marker" and item3.type == "marker3":
                                            ie_combine = True
                                            removeEnvironmentItem(item3)
                                            renpy.show_screen("marker3")
                                            item1.x = item1.original_x
                                            item1.y = item1.original_y
                                            item1.zorder = 0
                                            renpy.jump("inside_study1_screen")
                                            characterSay(who = "", what = ["Great job! Now let's take a closer look at each area to collect the evidence you identified."])
                                            # if (len(all_evidence_markers) != 3):
                                                # characterSay(who = "", what = [len(all_evidence_markers)])
