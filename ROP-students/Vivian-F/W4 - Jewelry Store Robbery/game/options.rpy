...
define config.name = _("ROPLevelW4")
...
define config.mouse['tabletop_lifted'] = [('/images/mouse/tabletop_lifted.png', 0, 0)]
...
define config.save_directory = "ROPLevelW4-1716921445"
