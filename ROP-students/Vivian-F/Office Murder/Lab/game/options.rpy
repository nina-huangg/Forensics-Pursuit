...
define config.name = _("Office Incident 1103 Lab")
...
define config.mouse['gun_blue'] = [('/images/mouse/gun_blue_mouse.png', 0, 0)]
define config.mouse['bottle'] = [('/images/mouse/bottle_mouse.png', 0, 0)]
define config.mouse['ninhydrin'] = [('/images/mouse/ninhydrin_mouse.png', 0, 0)]
...
define build.name = "ROP Level Lab"
...
define config.save_directory = "ROPLab"
