...
label instructions_key_arrows:
    ...
    "When you are investigating the scene, you may use the UP, DOWN, LEFT, and RIGHT arrow keys to look in a specific direction.\n\n>>hit space to continue"
    "Try pressing the UP arrow key now.\n\n\n>>hit space to continue"
    #hide screen move_on
...
label enter_scene:
    hide screen opening
    #show screen move_on
    "You may click on the door to enter.\n\n\n>>hit space to continue"
    #hide screen move_on
