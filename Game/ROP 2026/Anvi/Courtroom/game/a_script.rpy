    ...
    def generate_response(prompt, include_evidence_context=True):
        ...
        try:
            ...
            if include_evidence_context:
                system_context += (
                    f"The player will testify about the following case: On June 15th, 2026, a hit-and-run collision occurred on Highway 407. A motorcyclist was struck from behind and critically injured, while the driver fled the scene before emergency services arrived. Investigators recovered paint chip evidence and a tire tread impression from the collision scene. Surveillance footage identified several vehicles of interest, and known paint and tire samples were collected from those vehicles for comparison. Laboratory analysis showed that Sample 2 was consistent with the recovered paint chip based on exterior color, microscopic layer sequence, and FTIR analysis of the individual paint layers. Tire tread comparison also supported Sample 2 as being associated with the scene impression. Based on the combined forensic findings, the suspected vehicle was narrowed down to a silver 2006 Dodge Durango SLT."
