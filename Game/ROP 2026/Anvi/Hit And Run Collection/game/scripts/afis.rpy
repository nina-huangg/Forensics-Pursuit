...
# ---------------------------------------------------------------------------------------
    ...
    set_scores("print_1", {
        "print_1": (True, 99),
        "print_2": (False, 60), "print_3": (False, 37), "print_4": (False, 46),
        "print_5": (False, 39), "print_6": (False, 28), "print_7": (False, 15),
    })
    set_scores("print_2", {
        "print_1": (False, 60),
        "print_2": (True, 98),
        "print_3": (False, 37), "print_4": (False, 46),
        "print_5": (False, 39), "print_6": (False, 28), "print_7": (False, 15),
    })

    print_1_question = MCQ(
        question = "What kind of pattern is shown in the rightmost fingerprint?",
        choices = [("Loop", False), ("Arch", False), ("Whorls", True)],
        responses = [["This is not a loop pattern!", "Give it another go!"],
...
label import_print:
    ...
    if not prints[imported_print].processed:
        ...
        n "We've already processed this print."
        call screen afis
...
label show_results:
    ...
    if prints[imported_print].scores[current_print][0]:
        ...
        if imported_print == "print_1":
            n "According to the database... it belongs to Emily Exgirlfriend."
