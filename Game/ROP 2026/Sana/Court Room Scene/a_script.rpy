init python:
    ...
    def generate_response(prompt):
        ...
        try:
            url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.5-flash:generateContent?key=AQ.Ab8RN6K_6Nf32kk3fNL5BkZoYlLgqHKPl7ph4indjByP-ixJqQ"
            ...
            system_context = (
                ...
                f"The player will testify about the following case: Mary Sullivan was found deceased in her long term care facility. Cause of death is suspected to be death by blunt object. The accused is her daughter Jane Sullivan. She was identified as having visited the care facility the day of the murder between the time Mary was last seen alive and the identified time of death. A facility emergency prevented any supervision of Jane’s visit and any possible events between the visit and the victim’s identified time of death. The victim was found deceased by her assigned nurse during routine checkups who immediately contacted the police."
