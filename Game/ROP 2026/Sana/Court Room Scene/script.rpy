...
label start:
    ...
    s "Mary Sullivan was found deceased in her long term care facility. Cause of death is suspected to be death by blunt object"

    s "The accused is her daughter Jane Sullivan."

    s "She was identified as having visited the care facility the day of the murder between the time Mary was last seen alive and the identified time of death."

    s "A facility emergency prevented any supervision of Jane's visit and any possible events between the visit and the victim's identified time of death."
    s "The victim was found deceased by her assigned nurse during routine checkups who immediately contacted the police."
