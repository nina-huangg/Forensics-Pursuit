    ...
    def enable_evidence(specialty: Specialty) -> None:
        ...
        evidences.add_to_inventory(
            Item(
                name="Casefile",
                image_name="casefile",
                description="On the night of October 3rd, Joe Talwyn was found critically injured in the bathroom of a local club, later succumbing to his wounds. Witnesses report seeing a man, later identified as Travis Welce, fleeing the bathroom shortly after the altercation. Joe was found with Taylor Shift, who was attempting to stop the bleeding from his wounds. Evidence recovered from the scene includes a large, still-wet blood splatter, a separate dry blood splatter, a broken glass bottle believed to be the weapon, and several latent prints scattered throughout the bathroom. Travis Welce is the accused on trial, identified by witnesses as the man seen leaving the scene."
            )
        )
